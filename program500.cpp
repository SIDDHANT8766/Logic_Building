...
//////////////////////////////////////////////////////////////////////////////////////////
//            Singly Linear LinkedList in CPP  :-  Complete  (Generic)
/////////////////////////////////////////////////////////////////////////////////////////
...
void SinglyLLL<T> :: InsertFirst(T no)
{
    ...
    newn = new SinglyLLLnode<T>(no);           // memory allocation 
...
//////////////////////////////////////////////////////////////////////////////////////////
// Final Code of Doubly Linear LinkedList in CPP  :-  Complete  (Generic)
//////////////////////////////////////////////////////////////////////////////////////////
...
template <class T>
void DoublyLLL<T> :: InsertAtPost(T no , int pos)
{
    DoublyLLLnode<T> *newn = NULL;
    DoublyLLLnode<T> *temp = NULL;
    int iCnt = 0;
...
void DoublyLLL<T> :: DeleteFirst()
{
    ...
    else if(this-> first -> next == NULL)       // LL contains 1 DoublyLLLnode
    {
        delete(this-> first);
        this-> first = NULL;
    }
    else                     // LL contains more than one DoublyLLLnode
    {
        this-> first = this-> first -> next;
...
//////////////////////////////////////////////////////////////////////////////////////////
// Final Code of Singly Circular LinkedList in CPP  :-  Complete  (Generic)
//////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////
// Final Code of Doubly Circular LinkedList in CPP  :-  Complete  (Generic)
//////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 DoublyLLL<char> *dobj = new DoublyLLL<char>();     // Imp <int>
