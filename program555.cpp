...
// 
//   Fuction Name : LsFile
//   Description :  It is used least all file
//   Input :        Nothing
//   Output :       Nothing
//   Author :       Siddhant Vivek Gadkari 
//   Date :         16/01/2026
    ...
    for(i = 0; i < MAXOPENFILES; i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i] -> ptrinode -> FileName , name) == 0)
            {
                ...
                // Desallocate memmory of file table
              ...
              )
{
    ...
    printf("Number of byte that we want to write :%d\n",size);
    ...
    while(1)
    {
        ...
        else if(iCount == 2)  
        {
            ...
            else if(strcmp("write",Command[0]) == 0)
            {
                ...
                {
                    printf("Error : Unavle to write as there is no permission \n");
                }
                else if(iRet = ERR_INSUFFICIENT_DATA)
                {
                    printf("Error : Unable to write as there no space\n");
                }
                else
                {
            ...
            {
                printf("There is no such commant\n");
            }
