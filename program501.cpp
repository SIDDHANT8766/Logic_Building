...
int main()
{
    ...
    while(1)
    {
        ...
        cout<<"1: Insert new elements into Queue\n";
        cout<<"2: Remove the elements from queue\n";
        cout<<"3: Display the elements of queue\n";
        cout<<"4: Count the number of elements of queue\n";
        ...
        {
            case 1:
                cout<<"Enter the elements thst you want to insert\n";
                cin>>Value;
                qobj -> enqueue(Value);
                cout<<"Elements gets inserted Succesfully\n";
                break;
            ...
            case 0:
                  cout<<"Thank u for using application";
                  delete qobj;
                  return 0;

            default:
                    cout<<"Please enter the valide option\n";
        } // End of Swicth
